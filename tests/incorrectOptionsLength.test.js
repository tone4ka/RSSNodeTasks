...
const correctOptionsArr = ['--config', "C1-R1-C0-C0-A-R0-R1-R1-A-C1", '--input', "./input.txt", '--output', "./output.txt"]
const invalidOptionsArr = ["C1-R1-C0-C0-A-R0-R1-R1-A-C1", '--input', "./input.txt", '--output', "./output.txt"]
